...
public class SaveImage extends HttpServlet  {  
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<FileItem> items=upload.parseRequest(new ServletRequestContext(request));
          ...
          PreparedStatement ps=con.prepareStatement("select max(imgid) from Image");
          ...
          PreparedStatement ps1=con.prepareStatement("insert into Image values(?,?,?,?,?)");      
          ...
          out.println("<html>");
          out.println("<body>");
          out.println("<h3>Your Image Has Uploded</h3>");
